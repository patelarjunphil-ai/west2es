...
<body>
  ...
  <div class="header banner">
    <img src="<?= base_url('assets/images/west2.png') ?>" alt="School Image">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-header w-100 d-flex align-items-center justify-content-center" style="background: none; border-bottom: none;">
                <img src="<?= base_url('assets/images/logo1.png') ?>" alt="Logo" style="width:48px; height:48px; border-radius:50%; margin-right:12px; background:#fff; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
...
<?= $this->include('modals/admin_login_modal') ?>
<?= $this->include('modals/faculty_login_modal') ?>
<?= $this->include('modals/registration_modal') ?>
